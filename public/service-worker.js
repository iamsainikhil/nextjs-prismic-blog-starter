...
define(
    "./service-worker.js", [ "./workbox-ea903bce" ], (function(e) {
      "use strict";
      importScripts(), self.skipWaiting(), e.clientsClaim(),
          e.precacheAndRoute(
              [
                ...
                {
                  url :
                      "/_next/static/chunks/framework-c93ed74a065331c4bd75.js",
                  revision : "WbBN9MbdTmN-OAcsHtySh"
                },
                {
                ...
                {
                  url :
                      "/_next/static/chunks/pages/404-8897806309a9c55dadfa.js",
                  revision : "WbBN9MbdTmN-OAcsHtySh"
                },
                {
                  url :
                      "/_next/static/chunks/pages/_app-16ac4bda7e11195f378d.js",
                  revision : "WbBN9MbdTmN-OAcsHtySh"
                },
                {
                  url :
                      "/_next/static/chunks/pages/_error-91ee45bda8a4adb5406c.js",
                  revision : "WbBN9MbdTmN-OAcsHtySh"
                },
                {
                  url :
                      "/_next/static/chunks/pages/article/%5Buid%5D-7da3a805e4b6b824477e.js",
                  revision : "WbBN9MbdTmN-OAcsHtySh"
                },
                {
                  url :
                      "/_next/static/chunks/pages/category/%5Bcategory%5D-6cf9d034c28b710683b7.js",
                  revision : "WbBN9MbdTmN-OAcsHtySh"
                },
                {
                  url :
                      "/_next/static/chunks/pages/index-db5e8290fdf3bee756b8.js",
                  revision : "WbBN9MbdTmN-OAcsHtySh"
                },
                {
                  url :
                      "/_next/static/chunks/pages/tag/%5Btag%5D-d05ee67841990e416aca.js",
                  revision : "WbBN9MbdTmN-OAcsHtySh"
                },
                {
                  url :
                      "/_next/static/chunks/polyfills-a54b4f32bdc1ef890ddd.js",
                  revision : "WbBN9MbdTmN-OAcsHtySh"
                },
                {
                ...
                {
                  url :
                      "/_next/static/media/CeraRoundPro-Bold.d5d5f0d75db4717277ec87c6f3e05309.woff",
                  revision : "WbBN9MbdTmN-OAcsHtySh"
                },
                {
                  url :
                      "/_next/static/media/CeraRoundPro-Light.7350cc889a4ac294f13c3da2f831e001.woff",
                  revision : "WbBN9MbdTmN-OAcsHtySh"
                },
                {
                  url :
                      "/_next/static/media/CeraRoundPro-Medium.647ae5a91bb7dba38f076264c7b0284c.woff",
                  revision : "WbBN9MbdTmN-OAcsHtySh"
                },
                {
                  url :
                      "/_next/static/media/CeraRoundPro-Regular.51f02b1b1e211d8d9d8af32f39147068.woff",
                  revision : "WbBN9MbdTmN-OAcsHtySh"
                },
                {
          ...
          e.registerRoute("/", new e.NetworkFirst({
            ...
            plugins : [ {
              cacheWillUpdate :
                  async ({request : e, response : s, event : n, state : i}) =>
                      s && "opaqueredirect" === s.type ? new Response(s.body, {
                        ...
                        headers : s.headers
                          ...
                          "GET"),
          e.registerRoute(/^https:\/\/fonts\.(?:gstatic)\.com\/.*/i,
                          new e.CacheFirst({
                          ...
                          "GET"),
          e.registerRoute(/^https:\/\/fonts\.(?:googleapis)\.com\/.*/i,
                          ...
                          "GET"),
          e.registerRoute(/\.(?:eot|otf|ttc|ttf|woff|woff2|font.css)$/i,
                          new e.StaleWhileRevalidate({
                          ...
                          "GET"),
          e.registerRoute(/\.(?:jpg|jpeg|gif|png|svg|ico|webp)$/i,
                          new e.StaleWhileRevalidate({
                          ...
                          "GET"),
          e.registerRoute(/\/_next\/image\?url=.+$/i,
                          new e.StaleWhileRevalidate({
                          ...
                          "GET"),
          e.registerRoute(/\.(?:mp3|mp4)$/i, new e.StaleWhileRevalidate({
          ...
          e.registerRoute(/\.(?:css|less)$/i, new e.StaleWhileRevalidate({
            ...
            plugins : [ new e.ExpirationPlugin({
              ...
              purgeOnQuotaError : !0
                          ...
                          "GET"),
          e.registerRoute(/\/_next\/data\/.+\/.+\.json$/i,
                          new e.StaleWhileRevalidate({
                            cacheName : "next-data",
                            plugins : [ new e.ExpirationPlugin({
                              maxEntries : 32,
          ...
          e.registerRoute((({url : e}) => {
                          ...
                          "GET"),
          e.registerRoute((({url : e}) => !(self.origin === e.origin)),
                          new e.NetworkFirst({
