define(
    "./workbox-ea903bce.js", [ "exports" ], (function(t) {
      "use strict";
      try {
      ...
      const u = {
        cacheWillUpdate : async ({response : t}) =>
            ...
            f = t => [l.prefix, t, l.suffix]
                         .filter((t => t && t.length > 0))
                         .join("-"),
            w = t => t || f(l.precache), d = t => t || f(l.runtime);
      function p() {
      ...
      const g = new Set;
      function R(t) { return "string" == typeof t ? new Request(t) : t }
      class v {
        constructor(t, e) {
          this.h = {}, Object.assign(this, e), this.event = e.event, this.u = t,
          this.l = new m, this.p = [], this.m = [...t.plugins ],
          this.g = new Map;
        ...
        async cachePut(t, e) {
         ...
         f = l ? await async function(t, e, s, n) {
           ...
           if (e.url === i)
             return t.match(e, n);
           const r = p({}, n, {ignoreSearch : !0}), a = await t.keys(e, r);
           for (const e of a)
             if (i === y(e.url, s))
               return t.match(e, n)
      ...
      class x {
        constructor(t, e, {onupgradeneeded : s, onversionchange: n} = {}) {
          this._ = null, this.L = t, this.N = e, this.C = s,
          this.D = n || (() => this.close())
        }
        get db() { return this._ }
        async open() {
          if (!this._)
            return this._ = await new Promise(((t, e) => {
                     let s = !1;
                     setTimeout(
                         (() => {
                           s = !0,
                     ...
                     n.onerror = () => e(n.error), n.onupgradeneeded = t => {
                       ...
                       const e = n.result;
                       s ? e.close()
                         : (e.onversionchange = this.D.bind(this), t(e))
                     }
                   })),
                   this
        }
        ...
        close() { this._ && (this._.close(), this._ = null) }
      }
      ...
      for (const [t, e] of Object.entries(b))
        for (const s of e)
          s in IDBObjectStore.prototype &&
              (x.prototype[s] = async function(
                   e, ...n) { return await this.T(s, e, t, ...n) });
      try {
        self["workbox:expiration:6.1.5"] && _()
      } catch (t) {
      }
      const L = "cache-entries", N = t => {
        const e = new URL(t, location.href);
        return e.hash = "", e.href
      };
      class C {
        constructor(t) {
          this.P = t, this._ = new x("workbox-expiration", 1,
        ...
        async expireEntries(t, e) {
          const s = await this._.transaction(
              L, "readwrite", ((s, n) => {
                const i = s.objectStore(L)
                              .index("timestamp")
                ...
                n = [];
          for (const t of s)
            await this._.delete(L, t.id), n.push(t.url);
          return n
        }
        K(t) { return this.P + "|" + N(t) }
      }
      class E {
        constructor(t, e = {}) {
          this.O = !1, this.W = !1, this.M = e.maxEntries,
          this.A = e.maxAgeSeconds, this.S = e.matchOptions, this.P = t,
          this.I = new C(t)
        }
        async expireEntries() {
          if (this.O)
            return void (this.W = !0);
          this.O = !0;
          const t = this.A ? Date.now() - 1e3 * this.A : 0,
                e = await this.I.expireEntries(t, this.M),
                s = await self.caches.open(this.P);
          for (const t of e)
            await s.delete(t, this.S);
          this.O = !1, this.W && (this.W = !1, U(this.expireEntries()))
        }
        async updateTimestamp(t) { await this.I.setTimestamp(t, Date.now()) }
        ...
        async delete() { this.W = !1, await this.I.expireEntries(1 / 0) }
      }
      function D(t, e) {
        const s = e();
      ...
      , t.ExpirationPlugin = class {
        constructor(t = {}) {
          ...
          this.tt = t, this.A = t.maxAgeSeconds, this.et = new Map,
          t.purgeOnQuotaError &&
      ...
      , t.NetworkFirst = class extends q {
        ...
        async U(t, e) {
          ...
          let r;
          if (this.nt) {
            const {id : s, promise : a} =
                this.it({request : t, logs : n, handler : e});
            r = s, i.push(a)
          }
          const a =
              this.rt({timeoutId : r, request : t, logs : n, handler : e});
          i.push(a);
        ...
        it({request : t, logs: e, handler: s}) {
          ...
          return {
            promise: new Promise(
                (e => {n = setTimeout((async () => {e(await s.cacheMatch(t))}),
                                      1e3 * this.nt)})),
                id: n
          }
        }
